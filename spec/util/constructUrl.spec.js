...
describe("constructUrl", () => {
  ...
  it("should return a hash with center & zoom when these are given", () => {
    constructUrl(null, center, zoom, null, null)
      .should.equal("#/?center=50.100,10.100&zoom=10");
  });
