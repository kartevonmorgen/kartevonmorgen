...
const teamArray = [
  ...
  {name: "Helmut Wolman", color: "pink", homepage: "http://www.ideenhochdrei.org/de/verein/kennenlernen/menschen/helmut-wolmann/", image: require("../img/team/Helmut.jpg"), position: ["landingExplain.chapter5.chair", "landingExplain.chapter5.project-development"] },  
  {name: "David Ziegler", color: "berry", homepage: "https://slowtec.de/team.html#", image: require("../img/team/David.jpg"), position: ["slowtec GmbH","landingExplain.chapter5.software-development"] },
  {name: "Lisa Stehr", color: "green", image: require("../img/team/Lisa.jpg"), position: ["landingExplain.chapter5.lisa1", "landingExplain.chapter5.lisa2"] },
  {name: "Marten Röbel", color: "green", homepage: "http://martenroebel.de/", image: require("../img/team/Marten.jpg"), position: ["landingExplain.chapter5.marten"] },
  {name: "Markus Kohlhase", color: "green", homepage: "https://slowtec.de/team.html#", image: require("../img/team/Markus.jpg"), position: ["slowtec GmbH","landingExplain.chapter5.software-development"] },
  {name: "Florian Jostock", color: "pink", image: require("../img/team/placeholder_1.png"), position: ["landingExplain.chapter5.florian"] },
  {name: "Louisa Pieper", color: "blue", image: require("../img/team/Louisa.jpg"), position: ["landingExplain.chapter5.louisa", "landingExplain.chapter5.pr-marketing"] },
  {name: "Anja Dannemann", color: "blue", image: require("../img/team/Anja.jpg"), position: ["landingExplain.chapter5.anja", "landingExplain.chapter5.graphic-design"] },
  {name: "Xueqian Chen", color: "berry", image: require("../img/team/Xueqian.jpg"), position: ["landingExplain.chapter5.xueqian", "landingExplain.chapter5.pr-marketing"] },
  {name: "Frederik Schütz", color: "green", image: require("../img/team/Frederik.jpg"), position: ["landingExplain.chapter5.project-development"] },
  {name: "Linus Covic", color: "green", image: require("../img/team/Linus.jpg"), position: ["landingExplain.chapter5.linus", "landingExplain.chapter5.communication-marketing"] },
  {color: "blue", image: require("../img/team/placeholder_4.png"), position: ["landingExplain.chapter5.new-members"] }
]       

class LandingExplain extends Component {
