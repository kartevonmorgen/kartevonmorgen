...
const Form = props => {
  ...
  const { isEdit, license, dispatch, handleSubmit } = props;

  const t = (key) => props.t("entryForm." + key);
  ...
  <FormWrapper>
    ...
    <AddEntryForm
      action    = 'javascript:void();' >
        ...
        { props.error &&
          <div className= "err">
            { t("savingError") + ":" + props.error.message}
          </div>
        }
      ...
      <nav className="menu pure-g">
        <NavButton
          ...
          onClick = {() => {
            props.dispatch(initialize(EDIT.id, {}, EDIT.fields));
            props.dispatch(isEdit ? Actions.cancelEdit() : Actions.cancelNew());
          }}
          icon = "ban"
          text = { t("cancel") }
        />
